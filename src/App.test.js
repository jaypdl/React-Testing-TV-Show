...
//   mockFetchShow.mockResolvedValueOnce(seasonData) //! Because we decided to mock for the second test, had to add this for the original test
//   render(<App />)
...
test('Renders episodes when the API call returns', async () => {
  ...
  // we need to wait for the data to come back, then test for the header component
